...
class ListViewSS : AppCompatActivity() {
    var arreglo = EBaseDeDatos.tablaSistema!!.mostrarSSs()
    ...
    fun mostrarFormSS() {
        ...
        val dialogBuilder = MaterialAlertDialogBuilder(this)
            ...
            .setPositiveButton("Crear") { _, _ ->
                ...
                EBaseDeDatos.tablaSistema!!.crearSistemaSolar(nombreSS,extension,estrC)
                arreglo.clear()
                arreglo.addAll(EBaseDeDatos.tablaSistema!!.mostrarSSs())
                adaptor.notifyDataSetChanged()
    ...
    fun mostrarFormSSA() {
        val inflater = LayoutInflater.from(this)
        val formularioView = inflater.inflate(R.layout.form_ss, null)
        val s = EBaseDeDatos.tablaSistema!!.consultarSSPorID(idItemSeleccionado)
        ...
        val dialogBuilder = MaterialAlertDialogBuilder(this)
            ...
            .setPositiveButton("Actualizar") { _, _ ->
                ...
                EBaseDeDatos.tablaSistema!!.actualizarSS(idItemSeleccionado,i_n.text.toString(),s.getNumeroPlanetas(),i_e.text.toString().toDouble(),estrC)
                Toast.makeText(this, "Datos guardados", Toast.LENGTH_SHORT).show()
                arreglo.clear()
                arreglo.addAll(EBaseDeDatos.tablaSistema!!.mostrarSSs())
                adaptor.notifyDataSetChanged()
    ...
    fun abrirDialogo(){
        ...
        builder.setPositiveButton("Aceptar",
            DialogInterface.OnClickListener{
                dialog, which -> EBaseDeDatos.tablaSistema!!.eliminarSistema(idItemSeleccionado)
                arreglo.clear()
                arreglo.addAll(EBaseDeDatos.tablaSistema!!.mostrarSSs())
                adaptor.notifyDataSetChanged()
            }
